...
if(hide_state==true){$(".extended").hide();$(".extended-row").hide();$('#master_expand_link').text("Show All Notes");}else{$('#master_expand_link').text("Hide All Notes");$(".expand-link").hide();};if(typeof drawCharts==='function'){drawCharts()}
if(window.location.hash){var hash=window.location.hash;splits=hash.split(".");if(splits.length>1){page_loaded=true;return gotoHash(hash,true);}}
