hide_state=true;current_section="";$(".noscript-anchor").remove()
...
graph_waypoints=$('.content').waypoint(function(direction){if($(this.element).is(':visible')==false){return 0;}
id=$(this.element).attr('id');console.log("#"+id+".cite-link");item=$("#"+id+".cite-link");link_ref=item.attr("href");para_tag=item.attr("para_tag");$("#mobile-header-link").attr("href",link_ref);$("#mobile-header-link").attr("para_tag",para_tag);console.log(link_ref);});var waypoints=$('.section-anchor').waypoint(function(direction){if($(this.element).is(':visible')==false){return 0;}
